...
public class GameSix extends JPanel {
    Main vista;
    ...
    public GameSix(Main vista,Game game) {
    ...
    private Component createPanel() {
    	//a larin hepsi gizli c lerden sadece iki tane gizli degil bu sekilde a ve c yi bulmak kolay
