...
public class GameNine extends JPanel {
    Main vista;
    ...
    public GameNine(Main vista,Game game) {
...
// once c bul sonra a
        ...
        b56.setBackground(Color.cyan);
        b57.addActionListener(gameController);
        b57.setBackground(Color.cyan);
    ...
    public void displayMessage() {
        game.display(JOptionPane.showInputDialog("TEST PRESENT"));
}
}
