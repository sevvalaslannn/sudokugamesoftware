...
public class GameTen extends JPanel {
    Main vista;
    ...
    public GameTen(Main vista,Game game) {
    ...
    private Component createPanel() {
     // b lerin hepsi gizli a da bi tane haric hepsi gizli 
        ...
        b52.setBackground(Color.pink);
        b53.addActionListener(gameController);
        b53.setBackground(Color.pink);
        b54.addActionListener(gameController);
        b54.setBackground(Color.pink);
        ...
        b67.setBackground(Color.pink);
        b68.addActionListener(gameController);
        b68.setBackground(Color.pink);
        b69.addActionListener(gameController);
        b69.setBackground(Color.pink);
