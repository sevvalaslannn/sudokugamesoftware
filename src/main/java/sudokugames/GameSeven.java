...
public class GameSeven extends JPanel {
    Main vista;
    ...
    public GameSeven(Main vista,Game game) {
...
//a larin hepsi gizli b lerden sadece bir tane gizli degil bu sekilde a ve b yi bulmak kolay
